...

{
    ...
    //-------------------------------------------------------------------
    public Asst2TestDriver(String ObjInspectorName, boolean recursive, Vector<Object> objectsToInspect)
	throws Exception
    {
	this.recursive=recursive;
	setObjectInspectorInfo(ObjInspectorName);
	this.objectsToInspect = objectsToInspect;
    }
    //--------------------------------------------------------------------
    ...
    //==================== Assignment 3 deserialized objects =======
    
    Vector<Object> objectsToInspect;
